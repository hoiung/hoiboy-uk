...
I am not running that play. It's like trying to wrap shit in gold, but end of the day it is still shit. I would rather spend my hours building the thing that works (audit, foundation, per-harness build, ongoing maintenance) because right now, this is what matters. Yes, I will automate the bits of my own marketing where automation makes genuine sense, and yes this page will keep getting a little nicer over time. But the value is not in the wrapping. The value is in something that works reliably, now AND in 12 months, with the minimum maintenance burden possible.
