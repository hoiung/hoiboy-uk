...
<section id="section-engagement" aria-label="Engagement gate">
  ...
  <p>Manual attestation gate (the recorder does not auto-read the registry at page load). Tick to attest the engagement letter is signed and Recording §3 = <code>enabled-and-attendees-notified</code> (or <code>mixed</code> with this session ticked enabled). See <a href="https://hoiboy.uk/legal/privacy/" rel="noopener">Privacy Notice</a>.</p>
