...
so each page gets a distinct, correctly-sized social card instead of falling
back to the shared `hoi-mug.jpg` default (or, for the harness page, the old
1200×900 card which emitted a non-standard aspect ratio in feeds).
