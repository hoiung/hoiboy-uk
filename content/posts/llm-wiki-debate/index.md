...
Bear was on the fence with a funny smirk on his face. I had questions.
...
The core idea is sound. LLMs genuinely don't get bored updating cross-references. Humans genuinely do. And for reusable information and context that doesn't change much... compiling it once instead of re-reading everything from scratch each time makes sense.
...
I have a tendency to look at things under a microscope, and I can be critical at times, as I try to understand a design's intent, purpose and logic. Bear obviously knew my character, hence why he threw it into our wine time catch-up convo for his own personal entertainment lol.
