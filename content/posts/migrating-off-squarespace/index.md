...
So I came up with my own approach and built it into a small reusable skill in the harness, called /web-fidelity. (Building that skill was where I dogfooded a new piece of the harness, the Claude Code Dynamic Workflow and Security Guidance Plugin that we integrated into SST3.) The idea is dead simple. One page at a time:
