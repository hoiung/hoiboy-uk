...
1. Configure the live Cal.com event per consulting-ops#2 Phase 1 AC 1.1 (Mon-Fri 11:00-18:00 UK, on-the-hour-and-half slots, 10-min buffer, max 4/day, syncs to `hoiung@gmail.com`). Capture the live event URL.
