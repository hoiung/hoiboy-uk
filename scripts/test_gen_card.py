...
AI_CONSULTANCY_DESC = (
    "AI consulting for owner-operator-led teams: the AI Adoption Talk (FREE), "
    "AI Managed Harness Services, Business Automation Services, AI Adoption "
    "Training, and the AI Product Demo/MVP/Prototype Builder, plus a portfolio "
    "of client work. Audit-first builds, deliverable-anchored automation, "
