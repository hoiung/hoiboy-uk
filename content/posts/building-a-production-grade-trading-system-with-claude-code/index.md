...
Alongside the system, I built a development workflow I call SST3 (public repo: [SST3-AI-Harness](https://github.com/hoiung/sst3-ai-harness)). It's a methodology for working with AI agents: subagents do the research and planning, the main agent writes the code with full context and accountability. I documented every failure as an anti-pattern. Started with 5 anti-patterns. Now there's 16. Each one cites the specific issue where I first caught the problem. AP #16, for example, was born from me telling Claude: "you have a tendency to just fire and forget scripts, when what I need you to do is fire and monitor and ensure no problems."
